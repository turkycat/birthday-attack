...
# reserved pseudo-words used internally, fail if present in actual scripts
RESERVED_253 = 253 # OP_PUBKEYHASH
RESERVED_254 = 254 # OP_PUBKEY
RESERVED_255 = 255 # OP_INVALIDOPCODE
...
invalid_opcodes = [
    ...
    RESERVED_253, RESERVED_254, RESERVED_255
]

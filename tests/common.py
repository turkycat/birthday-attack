...
txoutput_01 = tx.TXOutput(TRANSACTION_01_HASH, TRANSACTION_01_INDEX, TRANSACTION_01_VALUE, TRANSACTION_01_SCRIPT)
...
txoutput_02 = tx.TXOutput(TRANSACTION_02_HASH, TRANSACTION_02_INDEX, TRANSACTION_02_VALUE, TRANSACTION_02_SCRIPT)
